...
class LoadingApp:
    ...
    def get_gui(self):
        ...
        self.progressbar = ct.CTkProgressBar(self.progress_frame, orientation="horizontal", width=350, mode="determinate", determinate_speed=0.5, fg_color="gray", height=7, progress_color="#e74f4b", corner_radius=1)
        self.progressbar.start()
        self.progressbar.set(0)
        self.progressbar.pack(side=TOP, pady=20)

        self.label = ct.CTkLabel(self.progress_frame, text="Google Workspaces", font=("Poppins", 40, "normal"), compound=LEFT, text_color="white").pack(pady=5)
